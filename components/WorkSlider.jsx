        ...
        cursor-pointer"
           ...
           flex items-center justify-center group"
             ...
             relative overflow-hidden group"
               ...
               from-transparent via-[#e838cc]
                to-[#4a22bd] opacity-0 group-hover:opacity-80
                 transition-all duration-700"
                      ></div>
                      {/* title  */}
                      <div className=" absolute bottom-0
                         transition-all duration-200 group-hover:xl:-translate-y-20 translate-y-full group-hover:-translate-y-10">
