     ...
     xl:text-left flex items-center justify-center h-full">
      ...
      ">
         ...
         <button className=" btn rounded-full border
          border-white/50 max-w-[178px] px-8 transition-all
          ...
          <span className=" group-hover:-translate-y-[120%]
           group-hover:opacity-0 transition-all duration-300">Let's talk</span>
           <BsArrowRight className=" -translate-y-[120%]
            opacity-0 group-hover:flex group-hover:-translate-y-0
